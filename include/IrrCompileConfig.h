...
#define NO_IRR_USE_NON_SYSTEM_JPEG_LIB_ 1
#define NO_IRR_USE_NON_SYSTEM_LIB_PNG_ 1
#define NO_IRR_USE_NON_SYSTEM_ZLIB_ 1
#define NO_IRR_USE_NON_SYSTEM_BZLIB_ 1
#define NO_IRR_COMPILE_WITH_LZMA_ 1
